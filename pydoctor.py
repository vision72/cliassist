...
class TextDoc(Doc):
    ...
    def docmodule(self, object, name=None, mod=None):
        ...
        if desc:
            dictionary["description"] = self.section('DESCRIPTION', desc) 
        ...
        if classes:
            ...
            dictionary["classes"] = self.section('CLASSES', join(contents, '\n'))
        ...
        if funcs:
            ...
            for key, value in funcs:
                contents.append(self.document(value, key, name))
            dictionary["funcs"] = self.section('FUNCTIONS', join(contents, '\n'))
        ...
        if data:
            ...
            dictionary["data"] = self.section('DATA', join(contents, '\n'))
        ...
        if hasattr(object, '__version__'):
            ...
            if version[:11] == '$' + 'Revision: ' and version[-1:] == '$':
                version = strip(version[11:-1])
            dictionary["version"] = self.section('VERSION', version)
            result = result + self.section('VERSION', version)
        if hasattr(object, '__date__'):
            dictionary["date"] = self.section('DATE', _binstr(object.__date__))
            result = result + self.section('DATE', _binstr(object.__date__))
        if hasattr(object, '__author__'):
            dictionary["author"] = self.section('DATE', _binstr(object.__author__))
            result = result + self.section('AUTHOR', _binstr(object.__author__))
        if hasattr(object, '__credits__'):
            dictionary["credits"] = self.section('DATE', _binstr(object.__credits__))
...
def render_doc(thing, title='Python Library Documentation: %s', forceload=0):
    ...
    if type(object) is _OLD_INSTANCE_TYPE:
        ...
        object = type(object)
        desc += ' object'
    dictionary = text.document(object, name)
    return dictionary
    # return title % desc + '\n\n' + 
...
def doc(thing, title='Python Library Documentation: %s', forceload=0):
    ...
    try:
        return render_doc(thing, title, forceload)
    ...
    def help(self, request):
        if type(request) is type(''):
            ...
            if request == 'help': self.intro()
                ...
                variable = doc(request, 'Help on %s:')
                return variable
